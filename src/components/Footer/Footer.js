...
const Footer = () => {
  ...
  <div>
    ...
    <Link className="link link-hover">Whitening</Link> 
    <Link className="link link-hover">Alignment</Link> 
    <Link className="link link-hover">Implants</Link> 
    <Link className="link link-hover">Teeth Braces</Link>
  </div> 
  <div>
